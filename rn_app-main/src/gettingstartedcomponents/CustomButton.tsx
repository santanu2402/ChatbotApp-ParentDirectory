...
import { changegettingstarted } from '../data/onlinedb/expressApi';
  ...
  const CustomButton = ({flatListRef, flatListIndex, dataLength, x,props}: Props) => {
      ...
      <TouchableWithoutFeedback
        onPress={async () => {
          if (flatListIndex.value < dataLength - 1) {
            ...
            const response=await changegettingstarted(authKey)
            if(response.success){
